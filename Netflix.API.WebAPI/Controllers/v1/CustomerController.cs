...
using Netflix.API.Application.Features.Customers.Commands.DeleteCustomerCommand;
using Netflix.API.Application.Features.Customers.Commands.UpdateCustomerCommand;
using Netflix.API.Application.Features.Customers.Queries.GetAllCustomers;
